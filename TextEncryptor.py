...
encrypting and decrypting text files. The important functions
for the user are the following
...
def encrypt_message(message=None, pin=None, algorithm='CBC', save_encrypted_message = False, save_file_path = 'encrypted_message.txt'):
    ...
    if message != None:
        ...
        print('Message to be encrypted: (IMPORTANT: press enter then control+D when done)')
        message = sys.stdin.read()#input('Message to be encrypted: ')
        print()
        binary_message = message_to_binary(message)
...
def decrypt_message(message=None, pin=None, algorithm='CBC', save_decrypted_message = False, save_file_path = 'decrypted_message.txt'):
    ...
    if message != None:
        ...
        print('Message to be decrypted: (IMPORTANT: press enter then control+D when done)')
